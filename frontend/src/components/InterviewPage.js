...
const InterviewPage = () => {
    ...
    //might need to change via env file for Docker
    const socket = io("http://localhost:8003");
    useEffect(() => {
        socket.emit("JOIN", { roomId: interviewId });
        return () => socket.emit("LEAVE", { roomId: interviewId });
    });
            ...
            <div className="d-flex justify-content-center mt-5">
                ...
                >
                    ...
                    <Modal.Footer>
                        <Button
                            variant="secondary"
                            onClick={handleCloseEndInterview}
                        >
                            Resume interview
                        </Button>
